...
usage example: ([link to interactive version](https://godbolt.org/z/hnb6n1Mh6))
...
usage example: ([link to interactive version](https://godbolt.org/z/E7ev9aYE6))
...
##### xslta_accessing_fixed_owning_pointer, xslta_accessing_fixed_owning_not_null_pointer

`rsv::xslta_accessing_fixed_owning_pointer<>` is the [`rsv::xslta_accessing_fixed_vector<>`](#xslta_accessing_fixed_vector) counterpart for owning pointers (like `rsv::TXSLTARefCountingPointer<>`).

`rsv::make_xslta_accessing_fixed_owning_not_null_pointer<>` is the version for "not null" owning pointers, like `rsv::TXSLTARefCountingNotNullPointer<>`.
